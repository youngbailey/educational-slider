$( document ).ready(function() {
    ...
    const myQuiz = [
      {
        'q': 'When did the Silent Film era start?',
        'options': [
          '1920s',
          '1890s',
          '1900s',
        ...
        'incorrectResponse': 'Correct Answer: 1890s'
      },
      {
        'q': 'When did the Silent Film era begin?',
        'options': [
          '1890s',
          '1920s'
        ],
        'correctIndex': 0,
        'correctResponse': 'Correct!',
        'incorrectResponse': 'It was sound-on-film!'
      },
      {
        'q': 'What revolutionized sound film?',
        'options': [
          'Sound-on-film',
          'Title Cards',
          'Orchestras',
        ...
        'correctIndex': 2,
        'correctResponse': 'Correct!',
        'incorrectResponse': 'It was Parasite!'
      },
      {
        'q': 'Why did tinting and toning lose popularity?',
        'options': [
          'Film was too fragile',
          'It looked bad'
        ],
        'correctIndex': 1,
        'correctResponse': 'Correct!',
        'incorrectResponse': 'Nope! Tinting and toning was very popular but sound-on-film made film reels even more fragile'
      },
      {
        'q': 'What was the first non-English film to win Best Picture at the Academy Awards?',
        'options': [
          'Roma',
          'A Fantastic Woman',
          'Parasite',
